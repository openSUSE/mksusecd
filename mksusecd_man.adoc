...
mksusecd supports media with three different installers:
...
mksusecd will by default create media with a Fedora/RHEL-style hybrid mode
...
- Agama options: https://agama-project.github.io/docs/user/boot_options
